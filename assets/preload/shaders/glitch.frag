...
// original shader from shadeytoy, remastered by mrsropical
...
const float glitchAmplitude = 0.3; // increase this
const float glitchNarrowness = 7.0;
...
void mainImage()
{
    ...
    shift = smoothstep(0.00001, 0.3, shift);
